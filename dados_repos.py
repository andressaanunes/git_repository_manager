...
class DadosRepositorios:
        ...
        def __init__(self, owner):
                ...
                self.access_token='seu_token_aqui '
        ...
        def cria_df_linguagens(self):
             ...
             nome = self.nomes_repos(repositorios)
             linguagens = self.nomes_linguagens(repositorios)

             dados = pd.DataFrame()
             dados['repository_name'] = nome
             dados['language'] = linguagens 

             return dados

# Salvando os dados das linguagens mais usadas nos repositórios em CSV
